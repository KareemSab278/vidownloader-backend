...
#     if os.path.exists(BROWSER_COOKIES_PATH):
#         logging.info("Using browser-extracted cookies.")
#         cookies_path = BROWSER_COOKIES_PATH
#     else:
#         logging.warning("Browser cookies not found. Falling back to cookies.txt.")
...
ydl_opts = {
    ...
    'merge_output_format': 'mp4',  # Merge audio/video streams if needed
    'cookiefile': cookies_path,
    'http_headers': {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36',
    },
